...
getSample(cfo::CalcFactor{<:DynPoint2VelocityPrior}, N::Int=1) = ([rand(cfo.factor.z) for _=1:N], )
...
getSample(cfo::CalcFactor{<:DynPoint2DynPoint2}, N::Int=1) = ([rand(cfo.factor.z) for _=1:N], )
...
getSample(cfo::CalcFactor{<:Point2Point2Velocity}, N::Int=1) = ([rand(cfo.factor.z) for _=1:N], )
