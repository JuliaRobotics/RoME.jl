...
export buildPose2OdoNN_01_FromElements,
    buildPose2OdoNN_01_FromWeights, loadPose2OdoNNModelIntoFlux

function buildPose2OdoNN_01_FromElements(
    W1::AbstractMatrix{<:Real} = zeros(4, 8),
...
function buildPose2OdoNN_01_FromWeights(pywe; pad::Bool = false)
    return buildPose2OdoNN_01_FromElements(
        pywe[1],
        pywe[2][:],
        pywe[3]',
        pywe[4][:],
...
@deprecate buildPyNNModel_01_FromElements(args...; kw...) buildPose2OdoNN_01_FromElements(
    args...;
    kw...,
)
@deprecate buildPyNNModel_01_FromWeights(args...; kw...) buildPose2OdoNN_01_FromWeights(
    args...;
    kw...,
)
