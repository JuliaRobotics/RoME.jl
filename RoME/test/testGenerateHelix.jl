...
@testset "test canonical helix generators" begin
    ...
    fg = generateGraph_Helix2DSlew!(
        ...
        postpose_cb = cb,
        solverParams = SolverParams(; useMsgLikelihoods = false),
    )
    ...
    fg = RoME.generateGraph_Helix2DSpiral!(
        200;
        rate_r = 0.6,
        rate_a = 6,
        radius = 100,
        solverParams = SolverParams(; graphinit = false),
    )
