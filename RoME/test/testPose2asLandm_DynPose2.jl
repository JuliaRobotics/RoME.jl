...
addFactor!(
    fg,
    [:x0; :l1],
    DynPose2Pose2(MvNormal(gtpt[:x0l1], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
...
addFactor!(
    fg,
    [:x0; :l11],
    DynPose2Pose2(MvNormal(gtpt[:x0l11], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
...
addFactor!(
    ...
    [:x0; :x1],
    VelPose2VelPose2(
        MvNormal(zeros(3), Matrix(Diagonal([xposesig; yposesig; thetasig] .^ 2))),
...
addFactor!(
    fg,
    [:x1; :l1],
    DynPose2Pose2(MvNormal(gtpt[:x1l1], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
addFactor!(
    fg,
    [:x1; :l11],
    DynPose2Pose2(MvNormal(gtpt[:x1l11], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
addVariable!(fg, :l2, Pose2)
addFactor!(
    fg,
    [:x1; :l2],
    DynPose2Pose2(MvNormal(gtpt[:x1l2], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
addVariable!(fg, :l12, Pose2)
addFactor!(
    fg,
    [:x1; :l12],
    DynPose2Pose2(MvNormal(gtpt[:x1l12], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
...
addFactor!(
    fg,
    [:x2; :l2],
    DynPose2Pose2(MvNormal(gtpt[:x2l2], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
addFactor!(
    fg,
    [:x2; :l12],
    DynPose2Pose2(MvNormal(gtpt[:x2l12], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
addVariable!(fg, :l3, Pose2)
addFactor!(
    fg,
    [:x2; :l3],
    DynPose2Pose2(MvNormal(gtpt[:x2l3], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
...
addFactor!(
    fg,
    [:x3; :l3],
    DynPose2Pose2(MvNormal(gtpt[:x3l3], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
addVariable!(fg, :l13, Pose2)
addFactor!(
    fg,
    [:x3; :l13],
    DynPose2Pose2(MvNormal(gtpt[:x3l13], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
...
addFactor!(
    fg,
    [:x4; :l3],
    DynPose2Pose2(MvNormal(gtpt[:x4l3], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
addFactor!(
    fg,
    [:x4; :l13],
    DynPose2Pose2(MvNormal(gtpt[:x4l13], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
addVariable!(fg, :l4, Pose2)
addFactor!(
    fg,
    [:x4; :l4],
    DynPose2Pose2(MvNormal(gtpt[:x4l4], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
addVariable!(fg, :l14, Pose2)
addFactor!(
    fg,
    [:x4; :l14],
    DynPose2Pose2(MvNormal(gtpt[:x4l14], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
...
addFactor!(
    fg,
    [:x5; :l4],
    DynPose2Pose2(MvNormal(gtpt[:x5l4], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
addFactor!(
    fg,
    [:x5; :l14],
    DynPose2Pose2(MvNormal(gtpt[:x5l14], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
...
addFactor!(
    fg,
    [:x6; :l4],
    DynPose2Pose2(MvNormal(gtpt[:x6l4], Matrix(Diagonal([0.1; 0.1; 0.01] .^ 2)))),
)
