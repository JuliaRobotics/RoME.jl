...
function driveOneBox!(
    ...
    for leg = 0:3
        odo, direction =
            _calcOdoBox(leg; slew_x = slew_x, length_x = length_x, length_y = length_y)
        lastPose =
            driveLeg!(fg, lastPose, odo, direction; postpose_cb = postpose_cb) |> getLabel
        #
    end
...
"""
function generateGraph_Boxes2D!(
    numposes::Integer = 16;
