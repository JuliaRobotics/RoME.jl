...
# Takes five
function MultipleFeatures2D(a, b, c, d, e, f, g, h, i)
    return MultipleFeatures2D(a, b, c, d, e, f, g, h, i, (3, 3, 2, 2, 2))
end
...
function (mm2d::MultipleFeatures2D)(
    ...
    dobimodal = len3b > 0
    if meas[3] > 0 && !dobimodal
        error("mm2d::MultipleFeatures2D -- bi-modal mismatch")
    else
        nothing
    end
