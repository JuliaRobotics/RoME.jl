...
function poseTrigAndAdd!(
    instSys::GenericInSituSystem,
    Ts::Float64,
    distrule::Float64,
    timerule::Float64,
    yawrule::Float64;
...
function poseTrigAndAdd!(
    ...
    return error(" Yeah, do it properly")
end

function processTreeTrackersUpdates!(
    instSys::InSituSystem,
    lsrFeats::Dict{Int, LaserFeatures},
    Ts::Float64,
    b1Dxb::Array{Float64, 1},
    DBG = Union{};
    dbgflag = true,
)
...
function advOdoByRules(
    ...
    for i = 1:size(DRS, 1)
        ...
        if trkfeats
            ...
            @time processTreeTrackersUpdates!(
                instSys,
                lsrFeats,
                DRS[i, 1],
                bmTbp,
