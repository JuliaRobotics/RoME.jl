...
mutable struct CameraIntrinsic
    ...
    function CameraIntrinsic(; x0 = 320.0, y0 = 240.0, fx = 510.0, fy = 510.0, s = 0.0)
        return new([[fx; s; x0]'; [0.0; fy; y0]'; [0.0; 0; 1]'])
    end
end
...
function project!(ret::Vector{Float64}, cm::CameraModelFull, pt::Vector{Float64})
    return project!(ret, cm.ci, cm.ce, pt)
end
